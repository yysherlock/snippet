...
if __name__ == "__main__":
	...
	#convertDcoref2CopaDoc('../copa-all.xml','copa_replace4.txt','../res/data/copaReplace4.txt')
	#convertDcoref2CopaDoc('../copa-all.xml','copa_replace1.txt','../res/data/copaReplace1.txt')
	#convertDcoref2CopaDoc('../copa-all.xml','copa_replace2.txt','../res/data/copaReplace2.txt')
	#convertDcoref2CopaDoc('../copa-all.xml','copa_replace3.txt','../res/data/copaReplace3.txt')
	#convertDcoref2CopaDoc('../copa-all.xml','copa_replace4.txt','../res/data/copaReplace4.txt')
	#convertDcoref2CopaDoc('../copa-all.xml','copa_replace6.txt','../res/data/copaReplace6.xml')
############################
	#convertDcoref2CopaDoc('../copa-all.xml','yuchen-dcoref-all.txt','../res/data/yuchen-nltk-copa-all.xml')
	#convertDcoref2CopaDoc('../copa-all.xml','correct-content.txt','../correct-copa-all.xml')
	convertDcoref2CopaDoc('../copa-all.xml','threeSentences.txt','../res/data/direct-nltk-copa-all.xml')
	#convertDcoref2CopaDoc('../copa-all.xml','correct-dcoref-all.txt','../res/data/correct-nltk-copa-all.xml')
